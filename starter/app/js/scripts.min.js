/*! jQuery v3.5.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function (e, t) {
    ...
    b.fn = b.prototype = {
        ...
        var e, t, n, i, r, o, s = arguments[0] || {},
            ...
            l = arguments.length,
            u = !1;
        for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || f(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
        ...
        isPlainObject: function (e) {
            var t, n;
            return !(!e || "[object Object]" !== u.call(e) || (t = i(e)) && ("function" != typeof (n = c.call(t, "constructor") && t.constructor) || h.call(n) !== p))
        },
    ...
    var C = function (e) {
        var t, n, i, r, o, s, a, l, u, c, h, p, d, f, g, m, v, y, x, w = "sizzle" + 1 * new Date,
            b = e.document,
            _ = 0,
            C = 0,
            T = le(),
        ...
        try {
            L.apply(j = $.call(b.childNodes), b.childNodes), j[b.childNodes.length].nodeType
        } catch (t) {
            L = {
        ...
        function ae(e, t, i, r) {
            var o, a, u, c, h, f, v, y = t && t.ownerDocument,
                b = t ? t.nodeType : 9;
            ...
            if (!r && (p(t), t = t || d, g)) {
                if (11 !== b && (h = K.exec(e)))
                    if (o = h[1]) {
                        ...
                        } else if (y && (u = y.getElementById(o)) && x(t, u) && u.id === o) return i.push(u), i
                    } else {
                    ...
                    if (v = e, y = t, 1 === b && (X.test(e) || F.test(e))) {
                        for ((y = ee.test(e) && ve(t.parentNode) || t) === t && n.scope || ((c = t.getAttribute("id")) ? c = c.replace(ie, re) : t.setAttribute("id", c = w)), a = (f = s(e)).length; a--;) f[a] = (c ? "#" + c : ":scope") + " " + xe(f[a]);
                        v = f.join(",")
                    }
                    try {
        ...
        for (t in n = ae.support = {}, o = ae.isXML = function (e) {
                ...
                return s != d && 9 === s.nodeType && s.documentElement && (f = (d = s).documentElement, g = !o(d), b != d && (r = d.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", oe, !1) : r.attachEvent && r.attachEvent("onunload", oe)), n.scope = ce((function (e) {
                ...
                })), m = m.length && new RegExp(m.join("|")), v = v.length && new RegExp(v.join("|")), t = J.test(f.compareDocumentPosition), x = t || J.test(f.contains) ? function (e, t) {
                    ...
                    return i || (1 & (i = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === i ? e == d || e.ownerDocument == b && x(b, e) ? -1 : t == d || t.ownerDocument == b && x(b, t) ? 1 : c ? O(c, e) - O(c, t) : 0 : 4 & i ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return h = !0, 0;
                    var n, i = 0,
                        r = e.parentNode,
                        ...
                        s = [e],
                        a = [t];
                    if (!r || !o) return e == d ? -1 : t == d ? 1 : r ? -1 : o ? 1 : c ? O(c, e) - O(c, t) : 0;
                ...
                var t, i = [],
                    r = 0,
                    o = 0;
                if (h = !n.detectDuplicates, c = !n.sortStable && e.slice(0), e.sort(D), h) {
                ...
                filter: {
                    ...
                    ATTR: function (e, t, n) {
                        return function (i) {
                            var r = ae.attr(i, e);
                            return null == r ? "!=" === t : !t || (r += "", "=" === t ? r === n : "!=" === t ? r !== n : "^=" === t ? n && 0 === r.indexOf(n) : "*=" === t ? n && -1 < r.indexOf(n) : "$=" === t ? n && r.slice(-n.length) === n : "~=" === t ? -1 < (" " + r.replace(R, " ") + " ").indexOf(n) : "|=" === t && (r === n || r.slice(0, n.length + 1) === n + "-"))
                        }
                    },
                        ...
                        return 1 === i && 0 === r ? function (e) {
                            ...
                            if (m) {
                                ...
                                if (f = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (x = (d = (u = (c = (h = (p = m)[w] || (p[w] = {}))[p.uniqueID] || (h[p.uniqueID] = {}))[e] || [])[0] === _ && u[1]) && u[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || f.pop();)
                                        if (1 === p.nodeType && ++x && p === t) {
                                            c[e] = [_, d, x];
                                            break
                                        }
                                } else if (y && (x = d = (u = (c = (h = (p = t)[w] || (p[w] = {}))[p.uniqueID] || (h[p.uniqueID] = {}))[e] || [])[0] === _ && u[1]), !1 === x)
                                    for (;
                                        (p = ++d && p && p[g] || (x = d = 0) || f.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++x || (y && ((c = (h = p[w] || (p[w] = {}))[p.uniqueID] || (h[p.uniqueID] = {}))[e] = [_, x]), p !== t)););
        ...
        function Ce(e, t, n, i, r, o) {
            return i && !i[w] && (i = Ce(i)), r && !r[w] && (r = Ce(r, o)), ue((function (o, s, a, l) {
                var u, c, h, p = [],
                    ...
                    v = n ? r || (o ? e : f || i) ? [] : s : m;
                if (n && n(m, v, a, l), i)
                    for (u = _e(v, d), i(u, [], a, l), c = u.length; c--;)(h = u[c]) && (v[d[c]] = !(m[d[c]] = h));
                if (o) {
                    if (r || e) {
                        if (r) {
                        ...
                        for (c = v.length; c--;)(h = v[c]) && -1 < (u = r ? O(o, h) : p[c]) && (o[u] = !(s[u] = h))
                    }
                } else v = _e(v === s ? v.splice(f, v.length) : v), r ? r(null, s, v, l) : L.apply(s, v)
            }))
        }
        ...
        function Te(e) {
            for (var t, n, r, o = e.length, s = i.relative[e[0].type], a = s || i.relative[" "], l = s ? 1 : 0, c = we((function (e) {
                    ...
                    var r = !s && (i || n !== u) || ((t = n).nodeType ? c(e, n, i) : h(e, n, i));
                    return t = null, r
                }]; l < o; l++)
                if (n = i.relative[e[l].type]) p = [we(be(p), n)];
                    ...
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[w]) {
                        ...
                        return Ce(1 < l && be(p), 1 < l && xe(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(W, "$1"), n, l < r && Te(e.slice(l, r)), r < o && Te(e = e.slice(r)), r < o && xe(e))
                    }
                    p.push(n)
                } return be(p)
        }
        return ye.prototype = i.filters = i.pseudos, i.setFilters = new ye, s = ae.tokenize = function (e, t) {
            ...
            var n, r, o, a, l, c, h = [],
                ...
                m = S[e + " "];
            if (!m) {
                for (t || (t = s(e)), n = t.length; n--;)(m = Te(t[n]))[w] ? h.push(m) : f.push(m);
                (m = S(e, (r = f, a = 0 < (o = h).length, l = 0 < r.length, c = function (e, t, n, s, c) {
                    var h, f, m, v = 0,
                        y = "0",
                        x = e && [],
                        w = [],
                        ...
                        E = C.length;
                    for (c && (u = t == d || t || c); y !== E && null != (h = C[y]); y++) {
                        if (l && h) {
                            for (f = 0, t || h.ownerDocument == d || (p(h), n = !g); m = r[f++];)
                                if (m(h, t || d, n)) {
                                    s.push(h);
                                    break
                                } c && (_ = T)
                        }
                        a && ((h = !m && h) && v--, e && x.push(h))
                    }
                    if (v += y, a && y !== v) {
                        for (f = 0; m = o[f++];) m(x, w, t, n);
                        if (e) {
                            if (0 < v)
                                for (; y--;) x[y] || w[y] || (w[y] = M.call(s));
                            w = _e(w)
                        }
                        L.apply(s, w), c && !e && 0 < w.length && 1 < v + o.length && ae.uniqueSort(s)
                    }
                    return c && (_ = T, u = b), x
                }, a ? ue(c) : c))).selector = e
            }
            ...
            var o, l, u, c, h, p = "function" == typeof e && e,
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (o = Q.needsContext.test(e) ? 0 : l.length; o-- && (u = l[o], !i.relative[c = u.type]);)
                    if ((h = i.find[c]) && (r = h(u.matches[0].replace(te, ne), ee.test(l[0].type) && ve(t.parentNode) || t))) {
                        if (l.splice(o, 1), !(e = r.length && xe(l))) return L.apply(n, r), n;
                        break
                    }
            }
            return (p || a(e, d))(r, t, !g, n, !t || ee.test(e) && ve(t.parentNode) || t), n
        }, n.sortStable = w.split("").sort(D).join("") === w, n.detectDuplicates = !!h, p(), n.sortDetached = ce((function (e) {
    ...
    function A(e, t, n) {
        return f(t) ? b.grep(e, (function (e, i) {
    ...
    (b.fn.init = function (e, t, n) {
        ...
        if (n = n || j, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof b ? t[0] : t, b.merge(this, b.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : m, !0)), D.test(i[1]) && b.isPlainObject(t))
                    for (i in t) f(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
            return (r = m.getElementById(i[2])) && (this[0] = r, this.length = 1), this
        }
        return e.nodeType ? (this[0] = e, this.length = 1, this) : f(e) ? void 0 !== n.ready ? n.ready(e) : e(b) : b.makeArray(e, this)
    }).prototype = b.fn, j = b(m);
    ...
    b.fn.extend({
        ...
        contents: function (e) {
            return null != e.contentDocument && i(e.contentDocument) ? e.contentDocument : (k(e, "template") && (e = e.content || e), b.merge([], e.childNodes))
        }
    }, (function (e, t) {
        b.fn[e] = function (n, i) {
            var r = b.map(this, t, n);
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = b.filter(i, r)), 1 < this.length && (L[e] || b.uniqueSort(r), N.test(e) && r.reverse()), this.pushStack(r)
        }
    }));
    var O = /[^\x20\t\r\n\f]+/g;
    ...
    b.Callbacks = function (e) {
        var t, n;
        e = "string" == typeof e ? (t = e, n = {}, b.each(t.match(O) || [], (function (e, t) {
            n[t] = !0
        })), n) : b.extend({}, e);
        var i, r, o, s, a = [],
            l = [],
                ...
                add: function () {
                    return a && (r && !i && (u = a.length - 1, l.push(r)), function t(n) {
                        b.each(n, (function (n, i) {
                            f(i) ? e.unique && h.has(i) || a.push(i) : i && i.length && "string" !== x(i) && t(i)
                        }))
                    }(arguments), r && !i && c()), this
                },
                remove: function () {
                    return b.each(arguments, (function (e, t) {
                        for (var n; - 1 < (n = b.inArray(t, a, n));) a.splice(n, 1), n <= u && u--
                    })), this
                },
                has: function (e) {
                ...
                r = {
                    ...
                    then: function (t, i, r) {
                                ...
                                var a = this,
                                    ...
                                    u = function () {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            u = e && ("object" == typeof e || "function" == typeof e) && e.then, f(u) ? r ? u.call(e, s(o, n, P, r), s(o, n, q, r)) : (o++, u.call(e, s(o, n, P, r), s(o, n, q, r), s(o, n, P, n.notifyWith))) : (i !== P && (a = void 0, l = [e]), (r || n.resolveWith)(a, l))
                                        }
                                    },
                                    c = r ? u : function () {
                                        try {
                                            ...
                                            b.Deferred.exceptionHook && b.Deferred.exceptionHook(e, c.stackTrace), o <= t + 1 && (i !== q && (a = void 0, l = [e]), n.rejectWith(a, l))
                                        }
                                    };
                        ...
                        return b.Deferred((function (e) {
                            n[0][3].add(s(0, e, f(r) ? r : P, e.notifyWith)), n[1][3].add(s(0, e, f(t) ? t : P)), n[2][3].add(s(0, e, f(i) ? i : q))
                        })).promise()
                    },
                    promise: function (e) {
        ...
        when: function (e) {
            ...
            if (t <= 1 && (z(e, s.done(a(n)).resolve, s.reject, !t), "pending" === s.state() || f(o[n] && o[n].then))) return s.then();
    ...
    function R() {
        m.removeEventListener("DOMContentLoaded", R), e.removeEventListener("load", R), b.ready()
    }
    b.fn.ready = function (e) {
        ...
        readyWait: 1,
        ready: function (e) {
            (!0 === e ? --b.readyWait : b.isReady) || (b.isReady = !0) !== e && 0 < --b.readyWait || I.resolveWith(m, [b])
        }
    }), b.ready.then = I.then, "complete" === m.readyState || "loading" !== m.readyState && !m.documentElement.doScroll ? e.setTimeout(b.ready) : (m.addEventListener("DOMContentLoaded", R), e.addEventListener("load", R));
    var W = function (e, t, n, i, r, o, s) {
            ...
            else if (void 0 !== i && (r = !0, f(i) || (s = !0), u && (s ? (t.call(e, i), t = null) : (u = t, t = function (e, t, n) {
                    return u.call(b(e), n)
                })), t))
    ...
    function U(e) {
        return e.replace(B, "ms-").replace(F, X)
    }
    var V = function (e) {
    ...
    function xe(e, t, n, i, r) {
        for (var o, s, a, l, u, c, h = t.createDocumentFragment(), p = [], d = 0, f = e.length; d < f; d++)
            ...
            for (s = s || h.appendChild(t.createElement("div")), a = (de.exec(o) || ["", ""])[1].toLowerCase(), l = ge[a] || ge._default, s.innerHTML = l[1] + b.htmlPrefilter(o) + l[2], c = l[0]; c--;) s = s.lastChild;
            b.merge(p, s.childNodes), (s = h.firstChild).textContent = ""
        } else p.push(t.createTextNode(o));
        for (h.textContent = "", d = 0; o = p[d++];)
            if (i && -1 < b.inArray(o, i)) r && r.push(o);
            else if (u = re(o), s = me(h.appendChild(o), "script"), u && ve(s), n)
    ...
    b.event = {
        ...
        add: function (e, t, n, i, r) {
            var o, s, a, l, u, c, h, p, d, f, g, m = Y.get(e);
            if (V(e))
                for (n.handler && (n = (o = n).handler, r = o.selector), r && b.find.matchesSelector(ie, r), n.guid || (n.guid = b.guid++), (l = m.events) || (l = m.events = Object.create(null)), (s = m.handle) || (s = m.handle = function (t) {
                        return void 0 !== b && b.event.triggered !== t.type ? b.event.dispatch.apply(e, arguments) : void 0
                    }), u = (t = (t || "").match(O) || [""]).length; u--;) d = g = (a = _e.exec(t[u]) || [])[1], f = (a[2] || "").split(".").sort(), d && (h = b.event.special[d] || {}, d = (r ? h.delegateType : h.bindType) || d, h = b.event.special[d] || {}, c = b.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, o), (p = l[d]) || ((p = l[d] = []).delegateCount = 0, h.setup && !1 !== h.setup.call(e, i, f, s) || e.addEventListener && e.addEventListener(d, s)), h.add && (h.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, c) : p.push(c), b.event.global[d] = !0)
        },
        remove: function (e, t, n, i, r) {
            var o, s, a, l, u, c, h, p, d, f, g, m = Y.hasData(e) && Y.get(e);
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(O) || [""]).length; u--;)
                    if (d = g = (a = _e.exec(t[u]) || [])[1], f = (a[2] || "").split(".").sort(), d) {
                        for (h = b.event.special[d] || {}, p = l[d = (i ? h.delegateType : h.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) c = p[o], !r && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, h.remove && h.remove.call(e, c));
                        s && !p.length && (h.teardown && !1 !== h.teardown.call(e, f, m.handle) || b.removeEvent(e, d, m.handle), delete l[d])
                    } else
        ...
        dispatch: function (e) {
            ...
            if (l.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, l)) {
                for (s = b.event.handlers.call(this, l, u), t = 0;
            ...
            if (l && u.nodeType && !("click" === e.type && 1 <= e.button))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                        for (o = [], s = {}, n = 0; n < l; n++) void 0 === s[r = (i = t[n]).selector + " "] && (s[r] = i.needsContext ? -1 < b(r, this).index(u) : b.find(r, this, null, [u]).length), s[r] && o.push(i);
                        o.length && a.push({
                            elem: u,
                            handlers: o
                        })
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && k(t, "input") && ke(t, "click", Ce), !1
                },
                trigger: function (e) {
                    var t = this || e;
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ce : Te, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && b.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[b.expando] = !0
    }, b.Event.prototype = {
        constructor: b.Event,
    ...
    function $e(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Z.hasData(e) && (o = Z.access(e), s = b.extend({}, o), Z.set(t, s))
        }
    }
    ...
    function Oe(e, t, n, i) {
        ...
        var r, s, a, l, u, c, h = 0,
            ...
            m = t[0],
            v = f(m);
        if (v || 1 < p && "string" == typeof m && !d.checkClone && Ae.test(m)) return e.each((function (r) {
            var o = e.eq(r);
            v && (t[0] = m.call(this, r, o.html())), Oe(o, t, n, i)
        }));
        if (p && (s = (r = xe(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = s), s || i)) {
            for (l = (a = b.map(me(r, "script"), Ne)).length; h < p; h++) u = r, h !== g && (u = b.clone(u, !0, !0), l && b.merge(a, me(u, "script"))), n.call(e[h], u, h);
            if (l)
                for (c = a[a.length - 1].ownerDocument, b.map(a, Le), h = 0; h < l; h++) u = a[h], fe.test(u.type || "") && !Y.access(u, "globalEval") && b.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? b._evalUrl && !u.noModule && b._evalUrl(u.src, {
    ...
    b.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(d.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || b.isXMLDoc(e)))
                for (s = me(c), i = 0, r = (o = me(e)).length; i < r; i++) a = o[i], "input" === (u = (l = s[i]).nodeName.toLowerCase()) && pe.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
                    for (o = o || me(e), s = s || me(c), i = 0, r = o.length; i < r; i++) $e(o[i], s[i]);
                else $e(e, c);
        ...
        b.fn[e] = function (e) {
            for (var n, i = [], r = b(e), o = r.length - 1, a = 0; a <= o; a++) n = a === o ? this : this.clone(!0), b(r[a])[t](n), s.apply(i, n.get());
    ...
    function Re(e, t, n) {
        ...
        return (n = n || ze(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = b.style(e, t)), !d.pixelBoxStyles() && qe.test(s) && Ie.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function Ue(e) {
        return b.cssProps[e] || Xe[e] || (e in Fe ? e : Xe[e] = function (e) {
            for (var t = e[0].toUpperCase() + e.slice(1), n = Be.length; n--;)
                if ((e = Be[n] + t) in Fe) return e
        }(e) || e)
    }
    ...
    function Ke(e, t, n) {
        var i = ze(e),
            r = (!d.boxSizingReliable() || n) && "border-box" === b.css(e, "boxSizing", !1, i),
            o = r,
            s = Re(e, t, i),
        ...
        return (!d.boxSizingReliable() && r || !d.reliableTrDimensions() && k(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === b.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === b.css(e, "boxSizing", !1, i), (o = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + Je(e, t, n || (r ? "border" : "content"), o, i, s) + "px"
    }
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = U(t),
                    l = Qe.test(t),
                    u = e.style;
                if (l || (t = Ue(a)), s = b.cssHooks[t] || b.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : u[t];
                "string" == (o = typeof n) && (r = te.exec(n)) && r[1] && (n = ae(e, t, r), o = "number"), null != n && n == n && ("number" !== o || l || (n += r && r[3] || (b.cssNumber[a] ? "" : "px")), d.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))
            }
        },
        css: function (e, t, n, i) {
            var r, o, s, a = U(t);
            return Qe.test(t) || (t = Ue(a)), (s = b.cssHooks[t] || b.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Re(e, t, i)), "normal" === r && t in Ze && (r = Ze[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), b.each(["height", "width"], (function (e, t) {
        b.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !Ve.test(b.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ke(e, t, i) : He(e, Ye, (function () {
                    return Ke(e, t, i)
                }))
            },
            set: function (e, n, i) {
                var r, o = ze(e),
                    ...
                    l = i ? Je(e, t, i, a, o) : 0;
                return a && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Je(e, t, "border", !1, o) - .5)), l && (r = te.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = b.css(e, t)), Ge(0, n, l)
            }
        }
    })), b.cssHooks.marginLeft = We(d.reliableMarginLeft, (function (e, t) {
        if (t) return (parseFloat(Re(e, "marginLeft")) || e.getBoundingClientRect().left - He(e, {
            marginLeft: 0
        }, (function () {
        ...
        css: function (e, t) {
            return W(this, (function (e, t, n) {
                var i, r, o = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (i = ze(e), r = t.length; s < r; s++) o[t[s]] = b.css(e, t[s], !1, i);
                    return o
                }
    ...
    function at() {
        nt && (!1 === m.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(at) : e.setTimeout(at, b.fx.interval), b.fx.tick())
    }
    ...
    function ht(e, t, n) {
        ...
        for (function (e, t) {
                var n, i, r, o, s;
                for (n in e)
                    if (r = t[i = U(n)], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = b.cssHooks[i]) && "expand" in s)
                        for (n in o = s.expand(o), delete e[i], o) n in e || (e[n] = o[n], t[n] = r);
                    else t[i] = r
            }(c, u.opts.specialEasing); o < s; o++)
            if (i = ht.prefilters[o].call(u, e, c, u.opts)) return f(i.stop) && (b._queueHooks(u.elem, u.opts.queue).stop = i.stop.bind(i)), i;
        return b.map(c, ct, u), f(u.opts.start) && u.opts.start.call(e, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), b.fx.timer(b.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
        })), u
    ...
    b.Animation = b.extend(ht, {
        ...
        prefilters: [function (e, t, n) {
            ...
            for (i in n.queue || (null == (s = b._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                ...
                for (i in h && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY], null == (u = m && m.display) && (u = Y.get(e, "display")), "none" === (c = b.css(e, "display")) && (u ? c = u : (ue([e], !0), u = e.style.display || u, c = b.css(e, "display"), ue([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === b.css(e, "float") && (l || (p.done((function () {
                        f.display = u
                    ...
                    display: u
                }), o && (m.hidden = !g), g && ue([e], !0), p.done((function () {
                    for (i in g || ue([e]), Y.remove(e, "fxshow"), d) b.style(e, i, d[i])
        ...
        return b.fx.off ? i.duration = 0 : "number" != typeof i.duration && (i.duration in b.fx.speeds ? i.duration = b.fx.speeds[i.duration] : i.duration = b.fx.speeds._default), null != i.queue && !0 !== i.queue || (i.queue = "fx"), i.old = i.complete, i.complete = function () {
            f(i.old) && i.old.call(this), i.queue && b.dequeue(this, i.queue)
        }, i
    }, b.fn.extend({
    ...
    b.fn.extend({
        attr: function (e, t) {
            return W(this, b.attr, e, t, 1 < arguments.length)
        },
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? b.prop(e, t, n) : (1 === o && b.isXMLDoc(e) || (r = b.attrHooks[t.toLowerCase()] || (b.expr.match.bool.test(t) ? pt : void 0)), void 0 !== n ? null === n ? void b.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : null == (i = b.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
    ...
    b.fn.extend({
        prop: function (e, t) {
            return W(this, b.prop, e, t, 1 < arguments.length)
        },
    ...
    b.fn.extend({
        val: function (e) {
            ...
            }))) : r ? (t = b.valHooks[r.type] || b.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : "string" == typeof (n = r.value) ? n.replace(xt, "") : null == n ? "" : n : void 0
        }
    }), b.extend({
        valHooks: {
            option: {
            ...
            select: {
                ...
                set: function (e, t) {
                    for (var n, i, r = e.options, o = b.makeArray(t), s = r.length; s--;)((i = r[s]).selected = -1 < b.inArray(b.valHooks.option.get(i), o)) && (n = !0);
    ...
    b.extend(b.event, {
        trigger: function (t, n, i, r) {
            ...
            if (s = d = a = i = i || m, 3 !== i.nodeType && 8 !== i.nodeType && !wt.test(y + b.event.triggered) && (-1 < y.indexOf(".") && (y = (x = y.split(".")).shift(), x.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[b.expando] ? t : new b.Event(y, "object" == typeof t && t)).isTrigger = r ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : b.makeArray(n, [t]), p = b.event.special[y] || {}, r || !p.trigger || !1 !== p.trigger.apply(i, n))) {
                ...
                for (o = 0;
                    (s = v[o++]) && !t.isPropagationStopped();) d = s, t.type = 1 < o ? l : p.bindType || y, (h = (Y.get(s, "events") || Object.create(null))[t.type] && Y.get(s, "handle")) && h.apply(s, n), (h = u && s[u]) && h.apply && V(s) && (t.result = h.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = y, r || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(v.pop(), n) || !V(i) || u && f(i[y]) && !g(i) && ((a = i[u]) && (i[u] = null), b.event.triggered = y, t.isPropagationStopped() && d.addEventListener(y, bt), i[y](), t.isPropagationStopped() && d.removeEventListener(y, bt), b.event.triggered = void 0, a && (i[u] = a)), t.result
            }
        },
    ...
    b.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map((function () {
                ...
                var e = this.type;
                return this.name && !b(this).is(":disabled") && Dt.test(this.nodeName) && !kt.test(e) && (this.checked || !pe.test(e))
            })).map((function (e, t) {
                var n = b(this).val();
    ...
    Ht.href = _t.href, b.extend({
        ...
        ajax: function (t, n) {
            ...
            var i, r, o, s, a, l, u, c, h, p, d = b.ajaxSetup({}, n),
                f = d.context || d,
            ...
            if (v.promise(T), d.url = ((t || d.url || _t.href) + "").replace(Ot, _t.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(O) || [""], null == d.crossDomain) {
                l = m.createElement("a");
                try {
            ...
            function E(t, n, s, l) {
                var h, p, m, w, _, C = n;
                u || (u = !0, a && e.clearTimeout(a), i = void 0, o = l || "", T.readyState = 0 < t ? 4 : 0, h = 200 <= t && t < 300 || 304 === t, s && (w = function (e, t, n) {
                ...
                }(d, T, s)), !h && -1 < b.inArray("script", d.dataTypes) && (d.converters["text script"] = function () {}), w = function (e, t, n, i) {
                    var r, o, s, a, l, u = {},
                        c = e.dataTypes.slice();
                    if (c[1])
        ...
        b[t] = function (e, n, i, r) {
            return f(n) && (r = r || i, i = n, n = void 0), b.ajax(b.extend({
                url: e,
                type: t,
                dataType: r,
                data: n,
        ...
        wrapAll: function (e) {
            var t;
            return this[0] && (f(e) && (e = e.call(this[0])), t = b(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map((function () {
    ...
    b.ajaxSetup({
        ...
        jsonpCallback: function () {
            var e = Ut.pop() || b.expando + "_" + Ct.guid++;
            return this[e] = !0, e
        }
        ...
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = f(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Vt, "$1" + r) : !1 !== t.jsonp && (t.url += (Tt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
            return s || b.error(r + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function () {
            s = arguments
        }, i.always((function () {
            void 0 === o ? b(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Ut.push(r)), s && f(o) && o(s[0]), s = o = void 0
        })), "script"
    })), d.createHTMLDocument = ((Xt = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Xt.childNodes.length), b.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (d.createHTMLDocument ? ((i = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href, t.head.appendChild(i)) : t = m), o = !n && [], (r = D.exec(e)) ? [t.createElement(r[1])] : (r = xe([e], t, o), o && o.length && b(o).remove(), b.merge([], r.childNodes)));
        var i, r, o
    }, b.fn.load = function (e, t, n) {
        var i, r, o, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = mt(e.slice(a)), e = e.slice(0, a)), f(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), 0 < s.length && b.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var i, r, o, s, a, l, u = b.css(e, "position"),
                c = b(e),
                h = {};
            "static" === u && (e.style.position = "relative"), a = c.offset(), o = b.css(e, "top"), l = b.css(e, "left"), ("absolute" === u || "fixed" === u) && -1 < (o + l).indexOf("auto") ? (s = (i = c.position()).top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), f(t) && (t = t.call(e, n, b.extend({}, a))), null != t.top && (h.top = t.top - a.top + s), null != t.left && (h.left = t.left - a.left + r), "using" in t ? t.using.call(e, h) : ("number" == typeof h.top && (h.top += "px"), "number" == typeof h.left && (h.left += "px"), c.css(h))
        }
    }, b.fn.extend({
        offset: function (e) {
        ...
        b.cssHooks[t] = We(d.pixelPosition, (function (e, n) {
            if (n) return n = Re(e, t), qe.test(n) ? b(e).position()[t] + "px" : n
        }))
    })), b.each({
        Height: "height",
        Width: "width"
    ...
    b.proxy = function (e, t) {
        var n, i, o;
        if ("string" == typeof t && (n = e[t], t = e, e = n), f(e)) return i = r.call(arguments, 2), (o = function () {
            return e.apply(t || this, i.concat(r.call(arguments)))
        }).guid = e.guid = e.guid || b.guid++, o
    }, b.holdReady = function (e) {
        e ? b.readyWait++ : b.ready(!0)
    }, b.isArray = Array.isArray, b.parseJSON = JSON.parse, b.nodeName = k, b.isFunction = f, b.isWindow = g, b.camelCase = U, b.type = x, b.now = Date.now, b.isNumeric = function (e) {
        var t = b.type(e);
    ...
    return b.noConflict = function (t) {
        return e.$ === b && (e.$ = Zt), t && e.jQuery === b && (e.jQuery = Yt), b
...
function (e, t) {
    ...
    function u(e, t) {
        var n = l(e),
            ...
            u = r(a.und(n[2]) ? 10 : n[2], .1, 100),
            c = r(a.und(n[3]) ? 0 : n[3], .1, 100),
            h = Math.sqrt(s / o),
            p = u / (2 * Math.sqrt(s * o)),
        ...
        function g(e) {
            var n = t ? t * e / 1e3 : e;
            return n = p < 1 ? Math.exp(-n * p * h) * (1 * Math.cos(d * n) + f * Math.sin(d * n)) : (1 + f * n) * Math.exp(-n * h), 0 === e || 1 === e ? e : 1 - n
        }
        return t ? g : function () {
            var t = i.springs[e];
            if (t) return t;
    ...
    var h, p, d = function () {
            ...
            return function (t, n, i, s) {
                if (0 <= t && t <= 1 && 0 <= i && i <= 1) {
                    ...
                    return function (e) {
                        return t === n && i === s || 0 === e || 1 === e ? e : r(u(e), n, s)
                    }
                }

                function u(n) {
                    for (var s = 0, l = 1; 10 !== l && a[l] <= n; ++l) s += e;
                    var u = s + (n - a[--l]) / (a[l + 1] - a[l]) * e,
                        c = o(u, t, i);
                    return c >= .001 ? function (e, t, n, i) {
                        ...
                        return t
                    }(n, u, t, i) : 0 === c ? u : function (e, t, n, i, o) {
                        for (var s, a, l = 0;
    ...
    function x(e) {
        return a.arr(e) ? e : (a.str(e) && (e = m(e) || e), e instanceof NodeList || e instanceof HTMLCollection ? [].slice.call(e) : [e])
    }
    ...
    function k(e, t, n) {
        if (w([n, "deg", "rad", "turn"], T(t))) return t;
        var r = i.CSS[t + n];
        if (!a.und(r)) return r;
    ...
    function A(e, t) {
        return a.dom(e) && !a.inp(e) && (!a.nil(S(e, t)) || a.svg(e) && e[t]) ? "attribute" : a.dom(e) && w(n, t) ? "transform" : a.dom(e) && "transform" !== t && D(e, t) ? "css" : null != e[t] ? "object" : void 0
    }
            ...
            return a.rgb(e) ? (n = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(t = e)) ? "rgba(" + n[1] + ",1)" : t : a.hex(e) ? (i = e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, (function (e, t, n, i) {
                ...
                if (0 == s) t = n = i = a;
                    ...
                    var c = a < .5 ? a * (1 + s) : a + s - a * s,
                        h = 2 * a - c;
                    t = u(h, c, o + 1 / 3), n = u(h, c, o), i = u(h, c, o - 1 / 3)
                }
    ...
    function P(e) {
        ...
        switch (e.tagName.toLowerCase()) {
            case "circle":
                return o = e, 2 * Math.PI * S(o, "r");
            case "rect":
                return 2 * S(r = e, "width") + 2 * S(r, "height");
            case "line":
                return $({
                    x: S(i = e, "x1"),
                    y: S(i, "y1")
            ...
            case "polyline":
                return O(e);
            case "polygon":
                return n = (t = e).points, O(t) + $(n.getItem(n.numberOfItems - 1), n.getItem(0))
        }
        var t, n, i, r, o
    }
    ...
    function I(e) {
        return v(e ? y(a.arr(e) ? e.map(x) : x(e)) : [], (function (e, t, n) {
    ...
    function W(e, t) {
        var n = b(t);
        if (/^spring/.test(n.easing) && (n.duration = u(n.easing)), a.arr(e)) {
            var i = e.length;
                        ...
                        var i = function (e, t) {
                                ...
                                return e.tweens.map((function (i) {
                                    var r = function (e, t) {
                                        ...
                                        s = a.arr(o) ? o[1] : o,
                                        l = T(s),
                                        u = M(t.target, e.name, l, t),
                                        c = n ? n.to.original : u,
                                        h = a.arr(o) ? o[0] : c,
                                        p = T(h) || T(u),
                                        d = l || p;
                                    return a.und(s) && (s = c), r.from = H(h, d), r.to = H(N(s, h), d), r.start = n ? n.end : 0, r.end = r.start + r.delay + r.duration + r.endDelay, r.easing = g(r.easing, r.duration), r.isPath = a.pth(o), r.isPathTargetInsideSVG = r.isPath && a.svg(t.target), r.isColor = a.col(r.from.original), r.isColor && (r.round = 1), n = r, r
                                }))
                            }(t, e),
                            r = i[i.length - 1];
                        return {
    ...
    function J(n) {
        ...
        var h, p, d, f, g, m, y, x, w = (p = _(e, h = n), f = B(d = _(t, h), h), y = V(m = U(g = R(h.targets), f), d), x = Q, Q++, C(p, {
            id: x,
            children: [],
            animatables: g,
            animations: m,
        ...
        function b() {
            var e = w.direction;
            "alternate" !== e && (w.direction = "normal" !== e ? "normal" : "reverse"), w.reversed = !w.reversed, i.forEach((function (e) {
        ...
        function E() {
            o = 0, s = T(w.currentTime) * (1 / J.speed)
        }
        ...
        function k(e) {
            for (var t = 0, n = w.animations, i = n.length; t < i;) {
                ...
                for (var c = r(e - u.start - u.delay, 0, u.duration) / u.duration, h = isNaN(c) ? 1 : u.easing(c), p = u.to.strings, d = u.round, f = [], g = u.to.numbers.length, m = void 0, y = 0; y < g; y++) {
                    var x = void 0,
                        b = u.to.numbers[y],
                        _ = u.from.numbers[y] || 0;
                    x = u.isPath ? z(u.value, h * b, u.isPathTargetInsideSVG) : _ + h * (b - _), d && (u.isColor && y > 2 || (x = Math.round(x * d) / d)), f.push(x)
                }
                var C = p.length;
                if (C) {
                    m = p[0];
                ...
                F[o.type](s.target, o.property, m, s.transforms), o.currentValue = m, t++
            }
        }
        ...
        function A(e) {
            var t = w.duration,
                ...
                h = t - w.endDelay,
                p = T(e);
            w.progress = r(p / t * 100, 0, 100), w.reversePlayback = p < w.currentTime, i && function (e) {
                if (w.reversePlayback)
                    for (var t = l; t--;) S(e, i[t]);
                else
                    for (var n = 0; n < l; n++) S(e, i[n])
            }(p), !w.began && w.currentTime > 0 && (w.began = !0, D("begin")), !w.loopBegan && w.currentTime > 0 && (w.loopBegan = !0, D("loopBegin")), p <= n && 0 !== w.currentTime && k(0), (p >= h && w.currentTime !== t || !t) && k(t), p > n && p < h ? (w.changeBegan || (w.changeBegan = !0, w.changeCompleted = !1, D("changeBegin")), D("change"), k(p)) : w.changeBegan && (w.changeCompleted = !0, w.changeBegan = !1, D("changeComplete")), w.currentTime = r(p, 0, t), w.began && D("update"), e >= t && (s = 0, w.remaining && !0 !== w.remaining && w.remaining--, w.remaining ? (o = a, D("loopComplete"), w.loopBegan = !1, "alternate" === w.direction && b()) : (w.paused = !0, w.completed || (w.completed = !0, D("loopComplete"), D("complete"), !w.passThrough && "Promise" in window && (u(), c(w)))))
        }
        return c(w), w.reset = function () {
            var e = w.direction;
            w.passThrough = !1, w.currentTime = 0, w.progress = 0, w.paused = !0, w.began = !1, w.loopBegan = !1, w.changeBegan = !1, w.completed = !1, w.changeCompleted = !1, w.reversePlayback = !1, w.reversed = "reverse" === e, w.remaining = w.loop, i = w.children;
            for (var t = l = i.length; t--;) w.children[t].reset();
            (w.reversed && !0 !== w.loop || "alternate" === e && 1 === w.loop) && w.remaining++, k(w.reversed ? w.duration : 0)
        }, w._onDocumentVisibility = E, w.set = function (e, t) {
            return X(e, t), w
        }, w.tick = function (e) {
            a = e, o || (o = a), A((a + (s - o)) * J.speed)
        }, w.seek = function (e) {
            A(T(e))
        }, w.pause = function () {
            w.paused = !0, E()
        }, w.play = function () {
            w.paused && (w.completed && w.reset(), w.paused = !1, Y.push(w), E(), Z())
        }, w.reverse = function () {
    ...
    function ee(e, t) {
        ...
        for (var r = i.length; r--;) {
            var o = i[r],
                s = o.animations;
            K(e, s), s.length || o.children.length || i.splice(r, 1)
        }
        n.length || i.length || t.pause()
    }
    return J.version = "3.2.1", J.speed = 1, J.suspendWhenDocumentHidden = !0, J.running = Y, J.remove = function (e) {
        for (var t = I(e), n = Y.length; n--;) ee(t, Y[n])
    }, J.get = M, J.set = X, J.convertPx = k, J.path = function (e, t) {
        ...
        var n = t.direction || "normal",
            ...
            c = "last" === s,
            h = a.arr(e),
            p = h ? parseFloat(e[0]) : parseFloat(e),
        ...
        return function (e, t, a) {
            if (l && (s = 0), u && (s = (a - 1) / 2), c && (s = a - 1), !v.length) {
                for (var g = 0; g < a; g++) {
                    if (r) {
                        var x = u ? (r[0] - 1) / 2 : s % r[0],
                            w = u ? (r[1] - 1) / 2 : Math.floor(s / r[0]),
                            b = x - g % r[0],
                            _ = w - Math.floor(g / r[0]),
                            C = Math.sqrt(b * b + _ * _);
                        "x" === o && (C = -b), "y" === o && (C = -_), v.push(C)
            ...
            return m + (h ? (d - p) / y : p) * (Math.round(100 * v[t]) / 100) + f
        }
        ...
        return n.duration = 0, n.add = function (i, r) {
            ...
            var h = n.duration;
            c.autoplay = !1, c.direction = n.direction, c.timelineOffset = a.und(r) ? h : N(r, h), l(n), n.seek(c.timelineOffset);
            var p = J(c);
            l(p), s.push(p);
            var d = V(s, e);
            return n.delay = d.delay, n.endDelay = d.endDelay, n.duration = d.duration, n.seek(0), n.reset(), n.autoplay && n.play(), n
        }, n
    }, J.easing = g, J.penner = f, J.random = function (e, t) {
...
function (e, t, n, i) {
    ...
    e.fn.pagepiling = function (r) {
        function o(t) {
            return e(".pp-section.active").index(".pp-section") > t.index(".pp-section") ? "up" : "down"
        }
        ...
        function s(t, n) {
            ...
            if (!i.activeSection.is(t)) {
                void 0 === i.animated && (i.animated = !0), void 0 !== i.anchorLink && function (e, t) {
                        L.anchors.length ? (location.hash = e, c(location.hash)) : c(String(t))
                    }(i.anchorLink, i.sectionIndex), i.destination.addClass("active").siblings().removeClass("active"), i.sectionsToMove = function (t) {
                        return "down" === t.yMovement ? e(".pp-section").map((function (n) {
                            if (n < t.destination.index(".pp-section")) return e(this)
                        })) : e(".pp-section").map((function (n) {
                            if (n > t.destination.index(".pp-section")) return e(this)
                        }))
                    }(i), "down" === i.yMovement ? (i.translate3d = "vertical" !== L.direction ? "translate3d(-100%, 0px, 0px)" : "translate3d(0px, -100%, 0px)", i.scrolling = "-100%", L.css3 || i.sectionsToMove.each((function (t) {
                        t != i.activeSection.index(".pp-section") && e(this).css(u(i.scrolling))
                    })), i.animateSection = i.activeSection) : (i.translate3d = "translate3d(0px, 0px, 0px)", i.scrolling = "0", i.animateSection = t), e.isFunction(L.onLeave) && L.onLeave.call(this, i.leavingSection, i.sectionIndex + 1, i.yMovement),
                    function (t) {
                        L.css3 ? (p(t.animateSection, t.translate3d, t.animated), t.sectionsToMove.each((function () {
                            p(e(this), t.translate3d, t.animated)
                        })), setTimeout((function () {
                            a(t)
                        }), L.scrollingSpeed)) : (t.scrollOptions = u(t.scrolling), t.animated ? t.animateSection.animate(t.scrollOptions, L.scrollingSpeed, L.easing, (function () {
                            l(t), a(t)
                    ...
                    function (t) {
                        L.menu && (e(L.menu).find(".active").removeClass("active"), e(L.menu).find('[data-menuanchor="' + t + '"]').addClass("active"))
                    }(i.anchorLink),
                    function (t, n) {
                        L.navigation && (e("#pp-nav").find(".active").removeClass("active"), t ? e("#pp-nav").find('a[href="#' + t + '"]').addClass("active") : e("#pp-nav").find("li").eq(n).find("a").addClass("active"))
                    }(i.anchorLink, i.sectionIndex), _ = i.anchorLink;
        ...
        function a(t) {
            e.isFunction(L.afterLoad) && L.afterLoad.call(this, t.anchorLink, t.sectionIndex + 1)
        }
        ...
        function h() {
            return (new Date).getTime() - E < N + L.scrollingSpeed
        }

        function p(e, t, n) {
            e.toggleClass("pp-easing", n), e.css(function (e) {
                return {
                    "-webkit-transform": e,
                    "-moz-transform": e,
                    "-ms-transform": e,
        ...
        function d(t) {
            var i = (new Date).getTime(),
                r = (t = t || n.event).wheelDelta || -t.deltaY || -t.detail,
                o = Math.max(-1, Math.min(1, r)),
                s = void 0 !== t.wheelDeltaX || void 0 !== t.deltaX,
                a = Math.abs(t.wheelDeltaX) < Math.abs(t.wheelDelta) || Math.abs(t.deltaX) < Math.abs(t.deltaY) || !s;
            M.length > 149 && M.shift(), M.push(Math.abs(r));
            var l = i - O;
            if (O = i, l > 200 && (M = []), !h()) {
                var u = m(e(".pp-section.active"));
                return f(M, 10) >= f(M, 70) && a && (o < 0 ? g("down", u) : o > 0 && g("up", u)), !1
            }
        }
        ...
        function g(e, t) {
            var n, i;
            if ("down" == e ? (n = "bottom", i = C.moveSectionDown) : (n = "top", i = C.moveSectionUp), t.length > 0) {
                if (! function (e, t) {
        ...
        function b(t) {
            ...
            if (! function t(n, i) {
                    i = i || 0;
                    var r = e(n).parent();
                    return !!(i < L.normalScrollElementTouchThreshold && r.is(L.normalScrollElements)) || i != L.normalScrollElementTouchThreshold && t(r, ++i)
                }(t.target) && x(n)) {
                var i = m(e(".pp-section.active"));
                if (i.length || t.preventDefault(), !h()) {
                    var r = y(n);
                    A = r.y, j = r.x, "horizontal" === L.direction && Math.abs(D - j) > Math.abs(k - A) ? Math.abs(D - j) > T.width() / 100 * L.touchSensitivity && (D > j ? g("down", i) : j > D && g("up", i)) : Math.abs(k - A) > T.height() / 100 * L.touchSensitivity && (k > A ? g("down", i) : A > k && g("up", i))
                }
            }
        }
        var _, C = e.fn.pagepiling,
            T = e(this),
            E = 0,
        ...
        e.extend(e.easing, {
        ...
        }), C.setScrollingSpeed = function (e) {
            L.scrollingSpeed = e
        }, C.setMouseWheelScrolling = function (e) {
            e ? T.get(0).addEventListener ? (T.get(0).addEventListener("mousewheel", d, !1), T.get(0).addEventListener("wheel", d, !1)) : T.get(0).attachEvent("onmousewheel", d) : T.get(0).addEventListener ? (T.get(0).removeEventListener("mousewheel", d, !1), T.get(0).removeEventListener("wheel", d, !1)) : T.get(0).detachEvent("onmousewheel", d)
        }, C.setAllowScrolling = function (e) {
            e ? (C.setMouseWheelScrolling(!0), function () {
                if (S) {
                    var e = v();
                    T.off("touchstart " + e.down).on("touchstart " + e.down, w), T.off("touchmove " + e.move).on("touchmove " + e.move, b)
                }
            }()) : (C.setMouseWheelScrolling(!1), function () {
                if (S) {
                    var e = v();
                    T.off("touchstart " + e.down), T.off("touchmove " + e.move)
                }
            }())
        }, C.setKeyboardScrolling = function (e) {
            L.keyboardScrolling = e
        }, C.moveSectionUp = function () {
            var t = e(".pp-section.active").prev(".pp-section");
            !t.length && L.loopTop && (t = e(".pp-section").last()), t.length && s(t)
        }, C.moveSectionDown = function () {
            var t = e(".pp-section.active").next(".pp-section");
            !t.length && L.loopBottom && (t = e(".pp-section").first()), t.length && s(t)
        }, C.moveTo = function (n) {
            var i;
            (i = isNaN(n) ? e(t).find('[data-anchor="' + n + '"]') : e(".pp-section").eq(n - 1)).length > 0 && s(i)
        }, e(L.sectionSelector).each((function () {
            e(this).addClass("pp-section")
        })), L.css3 && (L.css3 = function () {
            ...
            "touch-action": "none"
        }), C.setAllowScrolling(!0), e.isEmptyObject(L.navigation) || function () {
            e("body").append('<div id="pp-nav"><ul></ul></div>');
            var t = e("#pp-nav");
            t.css("color", L.navigation.textColor), t.addClass(L.navigation.position);
            for (var n = 0; n < e(".pp-section").length; n++) {
                var i = "";
                if (L.anchors.length && (i = L.anchors[n]), "undefined" !== L.navigation.tooltips) {
                    var r = L.navigation.tooltips[n];
                    void 0 === r && (r = "")
                }
                t.find("ul").append('<li data-tooltip="' + r + '"><a href="#' + i + '"><span></span></a></li>')
            }
            t.find("span").css("border-color", L.navigation.bulletsColor)
        }();
        var $ = e(".pp-section").length;
        e(".pp-section").each((function (t) {
            e(this).data("data-index", t), e(this).css("z-index", $), t || 0 !== e(".pp-section.active").length || e(this).addClass("active"), void 0 !== L.anchors[t] && e(this).attr("data-anchor", L.anchors[t]), void 0 !== L.sectionsColor[t] && e(this).css("background-color", L.sectionsColor[t]), L.verticalCentered && !e(this).hasClass("pp-scrollable") && function (e) {
                e.addClass("pp-table").wrapInner('<div class="pp-tableCell" style="height:100%" />')
            }(e(this)), $ -= 1
        })).promise().done((function () {
            L.navigation && (e("#pp-nav").css("margin-top", "-" + e("#pp-nav").height() / 2 + "px"), e("#pp-nav").find("li").eq(e(".pp-section.active").index(".pp-section")).find("a").addClass("active")), e(n).on("load", (function () {
                ! function () {
                    var i = n.location.hash.replace("#", ""),
                        r = e(t).find('.pp-section[data-anchor="' + i + '"]');
                    r.length > 0 && s(r, L.animateAnchor)
                }()
            })), e.isFunction(L.afterRender) && L.afterRender.call(this)
        })), e(n).on("hashchange", (function () {
            var i = n.location.hash.replace("#", "").split("/")[0];
            i.length && i && i !== _ && s(isNaN(i) ? e(t).find('[data-anchor="' + i + '"]') : e(".pp-section").eq(i - 1))
        })), e(t).keydown((function (t) {
            if (L.keyboardScrolling && !h()) switch (t.which) {
                case 38:
                case 33:
                    C.moveSectionUp();
                    break;
        ...
        })), L.normalScrollElements && (e(t).on("mouseenter", L.normalScrollElements, (function () {
            C.setMouseWheelScrolling(!1)
        })), e(t).on("mouseleave", L.normalScrollElements, (function () {
            C.setMouseWheelScrolling(!0)
        })));
        ...
        e(t).on("click touchstart", "#pp-nav a", (function (t) {
            ...
            mouseenter: function () {
                ...
                e('<div class="pp-tooltip ' + L.navigation.position + '">' + t + "</div>").hide().appendTo(e(this)).fadeIn(200)
            },
            mouseleave: function () {
...
function (e, t, n, i) {
    ...
    (function () {
        return !!r("transition")
    })() && (e.support.transition = new String(o("transition")), e.support.transition.end = l.transition.end[e.support.transition]), h() && (e.support.animation = new String(o("animation")), e.support.animation.end = l.animation.end[e.support.animation]), u() && (e.support.transform = new String(o("transform")), e.support.transform3d = c())
    ...
    if ("IntersectionObserver" in window) {
        ...
        let o = new IntersectionObserver((function (e, t) {
            e.forEach((function (e) {
                if (e.isIntersecting) {
                    let t = e.target;
                    t.style.backgroundImage = "url(" + t.dataset.bg + ")", o.unobserve(t)
                }
            }))
        }));
    ...
    e.onmouseover = i.play, t.onclick = r.play, $(".owl-carousel").owlCarousel({
        items: 1,
        dots: !0
